...
const ask= {
  ...
  spsRegister: (bseYr)=> `<ul>
    <li>${bseYr}.1.1. 기준 <mark>'공무원수당 등에 관한 규정'</mark> 제 10조(가족수당)에 의해 지급되는 대상자</li>
    <li>${bseYr}.1.1. 기준 법적혼인관계에 있는 자 (<small>사실혼은 제외</small>)<br>
      <small class="mt-2"><b>부부 공무원의 경우 본인의 보험에 가입하는 것이 원칙</b></small></li>
   </ul>`,

  childRegister: (bseYr, chldIsrAgRstcYr)=> {

    let limitAge = parseInt(bseYr) - parseInt(chldIsrAgRstcYr);
    ...
    <li>직계비속</li>
    <li>${bseYr}.1.1. 기준 <mark>'공무원수당 등에 관한 규정'</mark> 제 10조(가족수당)에 의해 지급되는 대상자</li>
    <li>${bseYr}.1.1. 기준 만 ${limitAge}세 미만 <small class="text-muted">(${chldIsrAgRstcYr}. 1.1. 이후 출생)</small></li>
    <li>단, 장애가 있는 자녀는 미혼인 경우에 한해 연령에 관계없이 가입이 가능합니다.<b>(증빙서류 필요)</b><br>
      <small class="mt-4 text-danger-emphasis"><b>부부 공무원의 자녀인 경우 중복가입여부를 확인하여 주시기 바랍니다.</b></small></li>
    </li>
...
export {notice, privacyNotice, ask}
